...
from Project_Test import file_compress
...
# compress
Button(delete_frame, text="Delete Compress", width=15, command=lambda: compress()).grid(row=0, column=0, padx=2)
# decompress
Button(delete_frame, text="Delete Decompress", width=15, command=lambda: decompress()).grid(row=0, column=1, padx=2)
