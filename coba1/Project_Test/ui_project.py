...
remove_all = Button(remove_frame, text="Remove All", width=15, command=remove_all)
remove_all.grid(row=0, column=0, padx=2)

remove_selection = Button(remove_frame, text="Remove Select", width=15, command=remove_selection)
remove_selection.grid(row=0, column=1, padx=2)

# File Name for Compress
...
# compress
Button(root, text="Compress", width=15, command=lambda: compress()).pack(pady=10)

# decompress
Button(root, text="Decompress", width=15, command=lambda: decompress()).pack(pady=10)

Button(root, text="Next", width=15, command=lambda: next_node()).pack(pady=10)
Button(root, text="Prev", width=15, command=lambda: prev_node()).pack(pady=10)
